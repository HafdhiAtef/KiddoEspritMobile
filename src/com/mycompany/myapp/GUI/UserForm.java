...
//-- DON'T EDIT ABOVE THIS LINE!!!
    ...
    private void showIfNotLoggedIn(UserForm form) {
        try {
            ...
            Image img = Image.createImage("/fb.png");
            myPic.setIcon(img);
    ...
    private void showIfLoggedIn(UserForm form) {
        ...
        Button continuer;
        continuer = new Button("Continuer vers l'application");
        String token = (String) Storage.getInstance().readObject("token");
                ...
                FaceBookAccess.getInstance().getUser("me", me, new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent evt) {
                        ...
                        continuer.addActionListener(new ActionListener() {
                            @Override
                            public void actionPerformed(ActionEvent evt) {
                              HomePage affForm = new HomePage(2);
