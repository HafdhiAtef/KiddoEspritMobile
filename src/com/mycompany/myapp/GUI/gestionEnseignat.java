...
import static Form.SignUpForm.userInsc;
 ...
 * @author yousra
 */
public class gestionEnseignat extends Form {
    ...
    public gestionEnseignat(Form previous) {
        current = this;
        ...
        tb.addMaterialCommandToLeftBar("List",
         ...
         * ********************************************************************************
         */
        Label a = new Label("Ajouter Enseignant");
        a.setUIID("Title");
        ...
        Label state = new Label("Compte enseignant activer");
        ...
        switchb.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ev) {
                ...
                if (c) {
                    state.setText("Compte enseignant activer");
                    enabled = 1;
                    state.getAllStyles().setFgColor(0x008000);
                } else {
                    state.setText("Compte enseignat désactiver");
                    enabled = 0;
