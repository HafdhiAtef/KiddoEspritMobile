 ...
 * @author yousra
 */
public class enseignantMenu extends Form {

    Form current;
    Form previous = Display.getInstance().getCurrent();

    public enseignantMenu(Form previous) {
        ...
        //loginStyle.setBgImage(MyApplication.theme.getImage("inscrit - Copie.jpg"));
         ...
         * ***********************************************************************************************
         */
        Button btnval = new Button("Nouveau Enseignat");
         ...
         * ***********************************************************************************************
         */
        Button btnval1 = new Button("Liste De Vos Enseignen"
                + "t");
